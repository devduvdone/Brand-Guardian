...
class VideoIndexerService:
    def __init__(self):
        ...
        self.vi_name = os.getenv("AZURE_VI_NAME","brand-guardian-project-001")
    ...
    def get_account_token(self,arm_access_token):
        """
        Exachanges the arm token to video indexer team
        """
        url = (
    ...
    def download_youtube_video(self, url, output_path="temp_video.mp4"):
        """
        it downloads the yt video to local file
        """
    ...
    # upload the video from local file to azure video indexer
    ...
    def wait_for_processing(self,video_id):
        ...
        while True:
            ...
            if state == "Processed":
                ...
                raise Exception("Vieo indexing failed in Azure")
